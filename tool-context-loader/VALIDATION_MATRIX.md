...
| VC-004 active-tool preload | Deferred to P1b | Requires `before_agent_start` index preload. |
| VC-005 no inactive-tool preload | Deferred to P1b | Requires preload matching. |
...
| VC-009 budget enforcement | Deferred to P1b/P1c | Requires preload/injection assembly. |
...
| VC-018 preload token budget | Deferred to P1b | Requires preload assembly. |
...
| VC-024 tool docs are not duplicated | Deferred to P1b | Requires preload output. |
