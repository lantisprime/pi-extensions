...
**P5d cmux-control is COMPLETE (PRs #126, #128, #130, #131, #132). P5+ orphan reaper bug fix MERGED (#134, codex v4 READY-TO-MERGE). P5d closed; reasonable next: P5b alternative terminal backends, --backend selector, NL → /agents bg intent-gate.**

- Current episode ID: `20260704-054011-post-merge-sync-p5d-cmux-control-complet-7ea6`
