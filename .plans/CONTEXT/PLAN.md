...
## Status: Phase 1 SHIPPED · Phase 2 SHIPPED (spec 48c998a7; M1–M4 implemented 2026-09-22, 28/28 wire tests, GLM-5.3 integration review fixed + approved)
...
| 3. Shape via `context` event | stale-dedupe, superseded-output collapse, task-switch eviction; dirty-prefix batching; frozen-per-burst shaping (B5); toolCall/result adjacency preserved | not started | — |
