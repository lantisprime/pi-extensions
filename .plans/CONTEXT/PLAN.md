...
## Status: Phase 1 SHIPPED · Phase 2 SHIPPED · Phase 3 SHIPPED (45/45) · Phase 4 SHIPPED (spec-phase4.md@8c4a3d0d v1.1; M7–M10 implemented 2026-09-22, 63/63 wire tests incl. 18 poison + 5 incident fixtures, GLM-5.3 post-review all findings fixed, Kimi-K3 6/6 invariants, Jev-adjudicated)
...
| 4. Poison defense deepening | Jev contradiction/staleness scoring, secret redaction, error-loop collapse, incident fixtures | SHIPPED 2026-09-22 — `spec-phase4.md` (pin 8c4a3d0d v1.1): M7 poison battery (one-call noul+score, act/review/pass, degraded≤review), M8 capture-time secret redaction (restoreHash identity), M9 error-loop collapse (occurrence-aware), M10 incident fixtures; AC-1..24 | dual-architect spec'd (GLM ×1 REVISE→fixed ×10 + Kimi K3 5-check) + Jev adjudication; implemented 63/63 wire tests; GLM post-review 2 slices REVISE → 18 findings ALL fixed; Kimi K3 6/6 invariants |
