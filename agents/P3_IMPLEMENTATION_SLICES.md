...
| `P5c-2-S6` | `tmux_drive_claude` composite tool (uses S1 + S2; must buffer across stdin reads per S6 design note in S1) | new `lib/drive.ts`, `index.ts` | OPEN | — | last (after S3+S4) |
